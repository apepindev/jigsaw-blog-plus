...
This is a slightly modified version of the blog starter template by [Jigsaw](https://jigsaw.tighten.com/) with **dark/light mode**, **personalised colours** and other minor modifications. You’ll only have to change a few settings and you’re ready to go.

![](source/assets/images/blog-plus-screenshot.png)

## Get started

This repo already contains everything to get your Jigsaw site running. You can just clone the repo and run the following:
